...
class BuildConfig extends Component {
    public $top_case = 'Black - Rp. 1.000.000';
    public $bottom_case = 'Black - Rp. 1.000.000';
    public $plate_ = 'Aluminium - Rp. 250.000';
    public $pcb_ = 'Hot-swap - Rp. 700.000';
    public $prev_top = 1;
    public $prev_bot = 1;
    public $prev_plate = 1;
    public $prev_pcb = 1;
    public $total = 2950000;
    public $code = '';
    public $build;
    public $layout = 1;
    public $topCase = 1;
    ...
    public function updatedTopCase() {
        ...
        $this->top_case = $top_case->name . ' - Rp. ' . number_format($top_case->price, 0, ',', '.');
    ...
    public function updatedBottomCase() {
        ...
        $this->bottom_case = $bottom_case->name . ' - Rp. ' . number_format($bottom_case->price, 0, ',', '.');
